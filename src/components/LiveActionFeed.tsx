...
// import { TrendingUp, Trophy, Zap, Sparkles } from "lucide-react";
...
//   return (
//     // 🟢 POSITIONING FIX:
//     // Mobile: bottom-24 (Clears Bottom Nav) + right-4
//     // Desktop: bottom-8 + right-8 (Clears Left Sidebar)
//     <div
...
//         <div className="absolute -inset-0.5 bg-gradient-to-r from-[#1F87FC] to-[#00ff88] rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-500"></div>

//         <div className="relative flex items-center gap-3 bg-[#0a0a0a]/60 backdrop-blur-xl border border-white/10 p-3 pr-6 rounded-2xl shadow-2xl">
//           {/* Avatar / Icon Circle with Glow */}
//           <div
//             className={`relative w-10 h-10 rounded-full flex items-center justify-center bg-[#1a1a24] border border-white/5`}
//           >
//             {/* Inner Glow Blob */}
//             <div
//               className={`absolute inset-0 rounded-full opacity-20 blur-md ${item.bg}`}
//             ></div>
...
//               {item.amount && (
//                 <span
//                   className={`font-mono font-bold ${item.type === "whale" ? "text-purple-400" : "text-[#00ff88]"}`}
//                 >
//                   {item.amount}
//                 </span>
//               )}
//             </div>
//             <div className="text-[11px] text-[#1F87FC] font-medium truncate max-w-[160px]">
//               {item.market}
//             </div>
//           </div>
