...
//   const { address } = useWallet(); // 🟢 Get connected user
...
//       try {
//         // A. Fetch Market Metadata
//         const res = await fetch("http://localhost:8000/markets"); // Check your port (3000 vs 8000)
...
//             endsAt: new Date(
//               rawMarket.timestamp * 1000 + 30 * 24 * 60 * 60 * 1000
//             ).toISOString(),
//             likes: 0,
//             comments: 0,
//             reposts: 0,
...
//     // Optional: Poll every 5s to update chart
...
//             />
//           ) : (
//             <div className="w-full h-full flex items-center justify-center text-[#1F87FC] text-4xl">
//               ▶
//             </div>
//           )}
//         </div>
...
//           {/* Stats Grid - 🟢 UPDATED to show My Shares vs Global Shares */}
...
//                 {formatNumber(prediction.yesShares)}
//               </div>
//             </div>
...
//                 {formatNumber(prediction.noShares)}
//               </div>
//             </div>
//           </div>
...
//           {/* Price Chart - 🟢 UPDATED to use chartData */}
...
//                 {/* 🟢 CHANGED: Use chartData instead of priceHistory */}
