...
import { useWallet } from "@/context/WalletContext"; // <--- NEW IMPORT
import { useTheme } from "next-themes"; // <--- NEW IMPORT

// 1. ADD 'settings' TO TYPES
...
export function Profile() {
  ...
  // Helper: Open Explorer
  const openExplorer = () => {
    if (address) {
      const baseUrl = chainId?.toString().includes("SEPOLIA")
  ...
  const tabs = [
    ...
    { id: "settings" as ProfileTab, label: "Settings", icon: Settings }, // <--- NEW TAB
  ];

  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-6 mb-20">
      {" "}
      {/* Added mb-20 for bottom nav space */}
      {/* Profile Header (Kept exactly as you had it) */}
      <div className="bg-[#0f0f1a] border border-[#1F87FC]/30 rounded-xl p-4 md:p-6 mb-4 md:mb-6">
            ...
            {!isEditing ? (
              <>
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-foreground text-lg md:text-xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <div className="text-center">
            <div className="text-xl md:text-2xl text-[#1F87FC]">
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6">
        <div className="bg-[#0f0f1a] border border-[#00ff88]/30 rounded-lg p-4 md:p-5">
          ...
          <div className="text-xl md:text-2xl text-[#00ff88]">
            {userStats.winRate}%
          </div>
        </div>
            ...
            {mockPredictions.slice(0, 6).map((prediction) => (
              ...
              >
                ...
                <div className="p-2 md:p-3">
                  <p className="text-xs md:text-sm text-foreground line-clamp-2 mb-2">
                    {prediction.question}
                  </p>
        ...
        {activeTab === "settings" && (
          <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="flex items-center justify-between bg-black/20 p-3 rounded-lg border border-[#1F87FC]/10">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 hover:bg-[#1F87FC]/20 rounded-md transition-colors text-muted-foreground hover:text-[#1F87FC]"
                    >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-500 hover:bg-red-500/20 transition-all font-medium"
            >
